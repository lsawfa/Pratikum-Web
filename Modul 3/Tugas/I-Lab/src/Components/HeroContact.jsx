    ...
    <>
      <form className="container mt-10 pt-20">
        ...
        <div class="mb-6">
          ...
          <input type="text" id="username" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg  block w-full p-2.5" placeholder="laryntsa" required />
        </div>
        <div class="mb-6">
